...
/**
     * @Route("/{userId}/cv/export/new/{cvId}", name="cv_export_new")
     *
     */
    public function exportNewAction(Request $request, $userId, $cvId)
    {
        ...
        // Add background image
//        $oBackgroundImage = new BackgroundImage();
//        $oBackgroundImage->setPath('./img/cv/cvbackground_new.png');
//        $oSlide1->setBackground($oBackgroundImage);
        ...
        $oNameText = $oSlide1->createRichTextShape()
            ...
            ->setOffsetX(853)
            ->setOffsetY(40);
        $oNameText->getActiveParagraph()->getAlignment()->setMarginLeft(0)->setHorizontal(Alignment::HORIZONTAL_LEFT);
